package com.devmello.music.modules;
...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(MusicPlugin.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link MusicPlugin#getPackage()} to be setup correctly, will fail silently otherwise.
     */
    @EventHandler
